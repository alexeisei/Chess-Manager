...
class GameController:
    ...
    def start_menu(self):
        ...
        while True:
            ...
            menu_list = [
                self.tournamentcontroller.tournament_menu,
                self.playercontroller.player_menu,
                self.game,
                self.report_menu,
                quit,
            ]
    ...
    def report_player_alpha_order(self):
        ...
        alpha_order = self.playercontroller.player_alpha_order()
    ...
    def report_tt_list(self):
        ...
        tournaments = self.tournamentcontroller.tournament_table.all()
    ...
    def report_all_rounds(self):
        """ give all the rounds in a tournament"""
        tt = self.load_tt()
        rounds = tt.rounds_list
        for round in rounds:
            self.menu.round_view(round)
        self.report_menu()

    def report_all_match(self):
        """ give all matches in a tournament"""
        tt = self.load_tt()
        rounds = tt.rounds_list
        for matches in rounds:
            self.menu.match_view(matches)
        self.report_menu()
    ...
    def load_tt(self):
        ...
        tournaments = self.tournamentcontroller.tournament_table.search(
            self.tournamentcontroller.tournamentquery.Tournament_name == f"{Tournament_name}"
        )
